...
export default () => {
  ...
  return id !== '' ? (
    ...
    <div class="container"style={{ textAlign: 'center', margin: '30vh auto', width: '70%' }}>
      <div class="login">
      <h3>Login to Chat Room</h3>
      <form onSubmit={event => handleSubmit(event)}>
        <p><input type="text" id="name" required placeholder="Type your name .." /></p><br />
        <p><input type="text" id="room" placeholder="Type a room name .." /></p><br />
